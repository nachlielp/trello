              ...
              <>
                ...
                {!verified && alert && (
                  <span className="auth-alert">
                    <span className="pyello-icon icon-warning" /> Enter your
                    email address
                  </span>
                )}
                {verified && (
                  <>
                    ...
                    {alert && (
                      <span className="auth-alert">
                        <span className="pyello-icon icon-warning" /> Wrong
                        login or password
                      </span>
                    )}
                  </>
              ...
              <>
                ...
                {verified && (
                  <>
                    ...
                    {alert && !fullName && (
                      <span className="auth-alert">
                        <span className="pyello-icon icon-warning" /> Enter full
                        name
                      </span>
                    )}
                    ...
                    {alert && !pass && (
                      <span className="auth-alert">
                        <span className="pyello-icon icon-warning" /> Enter
                        password
                      </span>
                    )}
                  </>
