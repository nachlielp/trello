...
export function usePopoverPosition(anchorEl, isOpen) {
  ...
  useEffect(() => {
    if (isOpen && anchorEl && popoverRef.current) {
      ...
      console.log('1. x and y of popover anchor element:', anchorRect.x, anchorRect.y);
      console.log('2. Height of child component:', anchorRect.height);
      console.log('3. x and y of child component:', anchorRect.left, anchorRect.top + window.scrollY + anchorRect.height);
    }
  }, [isOpen]);
